...
app.get('/api/mail', (_request, response) => {
    ...
    console.log("name","puto")
    console.log("process.env.SUBDOMAIN ? `${process.env.SUBDOMAIN}.${process.env.DNS}` : process.env.DNS",process.env.SUBDOMAIN ? `${process.env.SUBDOMAIN}.${process.env.DNS}` : process.env.DNS)
    console.log("code","123456")
    console.log("link",link)
    console.log("contact",contact)
    console.log("process.env.AUTHOR",process.env.AUTHOR)
    */
    ...
    send_mail(
        ...
        lang,
        {
            ...
            "link":new URL(`/confirm?code=123456`,link),
